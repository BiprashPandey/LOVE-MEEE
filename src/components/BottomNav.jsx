...
import { Home, CheckSquare, Timer, Calendar } from 'lucide-react';
...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 z-50 w-full max-w-md px-4 pb-3">
      <div className="flex items-center justify-around rounded-2xl border border-border bg-card/80 backdrop-blur-xl shadow-lg shadow-black/5 px-2 py-2">
